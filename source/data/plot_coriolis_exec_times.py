...
cfls = [2, 4, 8, 10, 16, 24, 32]
gmres_lo = ["gmres_nonsym_amg_lo/gmres_order1_profile_GW_ref6_cfl%s_NS1.csv"
            % cfl for cfl in cfls]
gmres_nlo = ["gmres_nonsym_amg_nlo/gmres_order2_profile_GW_ref4_cfl%s_NS1.csv"
             % cfl for cfl in cfls]
# gmres_lo_preonly = ["gmres_nonsym_amg_preonly_lo/gmres_order1_profile_GW_ref6_cfl%s_NS1.csv"
#                     % cfl for cfl in cfls]
# gmres_nlo_preonly = ["gmres_preonly_gamg_nlo/gmres_order2_profile_GW_ref4_cfl%s_NS1.csv"
#                      % cfl for cfl in cfls]
hybrid_lo = ["hybrid_nonsym_amg_lo/hybrid_order1_profile_GW_ref6_cfl%s_NS1.csv"
             % cfl for cfl in cfls]
hybrid_nlo = ["hybrid_nonsym_amg_nlo/hybrid_order2_profile_GW_ref4_cfl%s_NS1.csv"
              % cfl for cfl in cfls]
...
fig.savefig("coriolis_times.pdf",
